...
* @return     natural logarithm of the probability density function, or NaN if input is invalid
*
* @example
...
*
* @example
* double y = stdlib_base_dists_degenerate_logpdf( 3.0, 3.0 );
* // returns INFINITY
*
* @example
* double y = stdlib_base_dists_degenerate_logpdf( NAN, 0.0 );
* // returns NaN
*
* @example
* double y = stdlib_base_dists_degenerate_logpdf( 0.0, NAN );
* // returns NaN
*/
