...
#ifndef STDLIB_STATS_BASE_DISTS_DEGENERATE_QUANTILE_H
#define STDLIB_STATS_BASE_DISTS_DEGENERATE_QUANTILE_H
...
#endif // !STDLIB_STATS_BASE_DISTS_DEGENERATE_QUANTILE_H
