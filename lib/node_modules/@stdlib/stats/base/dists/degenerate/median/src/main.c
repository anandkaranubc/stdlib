...
* @return     median, or NaN if input is invalid
*
* @example
...
*
* @example
* double v = stdlib_base_dists_degenerate_median( 0.5 );
* // returns 0.5
*
* @example
* double v = stdlib_base_dists_degenerate_median( 10.0 );
* // returns 10.0
*
* @example
* double v = stdlib_base_dists_degenerate_median( NAN );
* // returns NaN
*/
