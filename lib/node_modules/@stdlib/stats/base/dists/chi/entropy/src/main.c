...
*
* @example
* double v = stdlib_base_dists_chi_entropy( 1.0 );
* // returns ~0.726
*
* @example
* double v = stdlib_base_dists_chi_entropy( -0.2 );
* // returns NaN
*
* @example
* double v = stdlib_base_dists_chi_entropy( NAN );
* // returns NaN
*/
double stdlib_base_dists_chi_entropy( const double k ) {
    ...
    double kh = k / 2.0;
    return stdlib_base_gammaln( kh ) +
           ( 0.5 * ( k - STDLIB_CONSTANT_FLOAT64_LN2 -
             ( ( k - 1.0 ) * stdlib_base_digamma( kh ) ) ) );
}
