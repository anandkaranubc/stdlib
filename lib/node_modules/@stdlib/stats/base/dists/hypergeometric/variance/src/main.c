...
* @return     variance of the distribution, or NaN if inputs are invalid
*
* @example
...
*
* @example
* double v = stdlib_base_dists_hypergeometric_variance( 2, 1, 1 );
* // returns 0.25
*
* @example
* double v = stdlib_base_dists_hypergeometric_variance( 10, 5, 12 );
* // returns NaN
*/
